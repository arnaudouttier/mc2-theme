...
// Custom Placeholder for MC2
$image_url = $event->thumbnail->exists ? $event->thumbnail->full->url : '/wp-content/themes/mc2-theme/assets/img/actus/placeholder-actus.jpg';
?>
	...
	>
		<img
			...
			<?php endif; ?>
			class="tribe-events-pro-photo__event-featured-image affiche-image"
		/>
	</a>
