...
<div id="page" class="site">
	...
	<div id="navigation-container">
		<div class="site-navigation agenda-list">
			...
			<nav id="site-navigation" class="main-navigation">
				<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e( 'Primary Menu', 'mc2-theme' ); ?></button>
				<?php
				wp_nav_menu(
					array(
